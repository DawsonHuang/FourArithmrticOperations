...
public class MyApp {
    public static void main(String[] args) throws IOException {
        ...
        if(i==1){
            ...
            System.out.println("注意以-e <ExerciseFile>.txt -a <AnswerFile>.txt的格式输入：");
            String[] str01 = in.nextLine().split(" ");
            Compare.Compare(str01[1],str01[3]);
        }
    }
...
class Calculate {
    ...
    class Compare {
        ...
        public static void Compare(String fileName1, String fileName2) throws IOException {
            File file01 = new File("Answer.txt");
